...
- El calendario del admin permite seleccionar fechas y aplicar: abrir/cerrar, precio por noche y mínimo de noches.
...
- Los precios predeterminados se guardan en `price_by_guests` para 1 a 6 huéspedes; las excepciones por fecha se guardan en `calendar_rules`.
